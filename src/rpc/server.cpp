...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RESQ features */
        {"resq", "masternode", &masternode, true, true, false},
        {"resq", "listmasternodes", &listmasternodes, true, true, false},
        {"resq", "getmasternodecount", &getmasternodecount, true, true, false},
        {"resq", "masternodeconnect", &masternodeconnect, true, true, false},
        {"resq", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"resq", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"resq", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"resq", "masternodecurrent", &masternodecurrent, true, true, false},
        {"resq", "masternodedebug", &masternodedebug, true, true, false},
        {"resq", "startmasternode", &startmasternode, true, true, false},
        {"resq", "createmasternodekey", &createmasternodekey, true, true, false},
        {"resq", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"resq", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"resq", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"resq", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"resq", "getmasternodescores", &getmasternodescores, true, true, false},
        {"resq", "mnbudget", &mnbudget, true, true, false},
        {"resq", "preparebudget", &preparebudget, true, true, false},
        {"resq", "submitbudget", &submitbudget, true, true, false},
        {"resq", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"resq", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"resq", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"resq", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"resq", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"resq", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"resq", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"resq", "checkbudgets", &checkbudgets, true, true, false},
        {"resq", "mnsync", &mnsync, true, true, false},
        {"resq", "spork", &spork, true, true, false},
        {"resq", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzresqseed", &getzresqseed, false, false, true},
        {"zerocoin", "setzresqseed", &setzresqseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzresq", &searchdzresq, false, false, true},
        {"zerocoin", "dzresqstate", &dzresqstate, false, false, true}
