...
extern UniValue setzresqseed(const UniValue& params, bool fHelp);
extern UniValue getzresqseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzresq(const UniValue& params, bool fHelp);
extern UniValue dzresqstate(const UniValue& params, bool fHelp);
