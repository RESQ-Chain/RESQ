...
//    privacyAction->setStatusTip(tr("Privacy Actions for zRESQ"));
...
//    tabGroup->addAction(privacyAction);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RESQ Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RESQ"));
