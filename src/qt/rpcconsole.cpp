                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRESQPathCustom = GetArg("-zresqbackuppath", "");
    ...
    if(!strzRESQPathCustom.empty()) {
        ui->wallet_customzresqbackuppath->setText(QString::fromStdString(strzRESQPathCustom));
        ui->wallet_customzresqbackuppath_label->setVisible(true);
        ui->wallet_customzresqbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRESQPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the RESQ RPC console.") + "<br>" +
