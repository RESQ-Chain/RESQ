...
#ifndef RESQ_ZRESQWALLET_H
#define RESQ_ZRESQWALLET_H
...
public:
    CzRESQWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZRESQ(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZRESQ(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
