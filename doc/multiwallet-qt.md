...
In order to support loading of multiple wallets in resq-qt, a few changes in the UI architecture will be needed.
...
Changes to resq.cpp
----------------------
resq.cpp is the entry point into resq-qt, and as such, will require some minor modifications to provide hooks for
