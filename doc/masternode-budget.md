...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<resq_address\> \<monthly_payment_resq\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<resq_address\> \<monthly_payment_resq\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` RESQ.
