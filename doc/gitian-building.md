...
*Setup instructions for a gitian build of RESQ using a Debian VM or physical system.*
...
Clone the git repositories for resq and gitian and then checkout the resq version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/resq-crypto/resq.git
cd resq
...
Follow the instructions in [doc/release-process.md](release-process.md) in the resq repository
...
To build RESQ (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the resq repository.
...
```bash
    ...
    From https://github.com/resq-crypto/resq
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/resq-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/resq-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/resq-build.assert
```
...
[resq/gitian.sigs](https://github.com/resq-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
