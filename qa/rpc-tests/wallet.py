...
#   c) node1 mines 32 blocks, so now node 0 has 60001resq, node 1 has 4250resq, node2 has none.
#   d) node0 sends 601 resq to node2, in two transactions (301 resq, then 300 resq).
