...
RESOURCES += src/qt/resq.qrc src/qt/resq_locale.qrc

TRANSLATIONS += src/qt/locale/resq_bg.ts \
                src/qt/locale/resq_de.ts \
                src/qt/locale/resq_en.ts \
                src/qt/locale/resq_es.ts \
                src/qt/locale/resq_fi.ts \
                src/qt/locale/resq_fr.ts \
                src/qt/locale/resq_it.ts \
                src/qt/locale/resq_ja.ts \
                src/qt/locale/resq_pl.ts \
                src/qt/locale/resq_pt.ts \
                src/qt/locale/resq_ru.ts \
                src/qt/locale/resq_sk.ts \
                src/qt/locale/resq_sv.ts \
                src/qt/locale/resq_vi.ts \
                src/qt/locale/resq_zh_CN.ts \
                src/qt/locale/resq_zh_TW.ts
