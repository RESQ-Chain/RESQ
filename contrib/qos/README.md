...
This means one can have an always-on resqd instance running, and another local resqd/resq-qt instance which connects to this node and receives blocks from it.
