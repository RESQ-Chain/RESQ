...
Setup
---------
Configuring the github-merge tool for the RESQ repository is done in the following way:

    git config githubmerge.repository RESQ-Project/RESQ
...
A script to optimize png files in the RESQ
