...
The RESQ Core project operates an open contributor model where anyone is
...
The following applies to code changes to the RESQ Core project, and is not to be
confused with overall RESQ Network Protocol consensus changes.

Whether a pull request is merged into RESQ Core rests with the project merge
...
Patches that change RESQ consensus rules are considerably more involved than
...
Where a patch set proposes to change the RESQ consensus, it must have been
