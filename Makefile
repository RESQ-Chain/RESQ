...
pkgdatadir = $(datadir)/resq
pkgincludedir = $(includedir)/resq
pkglibdir = $(libdir)/resq
pkglibexecdir = $(libexecdir)/resq
...
ACLOCAL = ${SHELL} /home/paulh/github/RESQ/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/paulh/github/RESQ/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/paulh/github/RESQ/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/paulh/github/RESQ/build-aux/missing automake-1.15
...
MAINT = 
MAKEINFO = ${SHELL} /home/paulh/github/RESQ/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = resq
PACKAGE_BUGREPORT = www.resq.org
PACKAGE_NAME = Resq Core
PACKAGE_STRING = Resq Core 3.1.2
PACKAGE_TARNAME = resq
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/paulh/github/RESQ
abs_srcdir = /home/paulh/github/RESQ
abs_top_builddir = /home/paulh/github/RESQ
abs_top_srcdir = /home/paulh/github/RESQ
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/paulh/github/RESQ/build-aux/install-sh
...
DIST_CONTRIB = $(top_srcdir)/contrib/resq-cli.bash-completion \
	       $(top_srcdir)/contrib/resq-tx.bash-completion \
	       $(top_srcdir)/contrib/resqd.bash-completion \
...
COVERAGE_INFO = baseline.info \
  test_resq_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_resq_coverage.info test_resq.info
...
$(OSX_APP)/Contents/MacOS/RESQ-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
#test_resq.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_resq -o $@
...
#functional_test.info: test_resq_filtered.info
...
#test_resq_coverage.info: baseline_filtered.info test_resq_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_resq_filtered.info -o $@

#total_coverage.info: test_resq_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_resq_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_resq.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
